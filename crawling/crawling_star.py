...
if __name__=="__main__":
    ...
    driver.implicitly_wait(3)
    driver.find_element_by_xpath('/html/body/app-root/app-modal/div/div/div/modal-contents/div/modal-login/input[1]').send_keys(args.id)
    driver.implicitly_wait(3)
    driver.find_element_by_xpath('/html/body/app-root/app-modal/div/div/div/modal-contents/div/modal-login/input[2]').send_keys(args.pwd)
    driver.implicitly_wait(3)
